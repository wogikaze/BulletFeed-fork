...
HOLD_INDEX = ROOT / "backend" / "tests" / "gold" / "personalization" / "v01" / "blind" / "index.json"
...
def main() -> None:
    ...
    if violations:
        raise SystemExit("personalization Gold leakage into production code:\n" + "\n".join(violations))
    print(f"personalization Gold isolation OK: {len(forbidden)} forbidden tokens scanned")
