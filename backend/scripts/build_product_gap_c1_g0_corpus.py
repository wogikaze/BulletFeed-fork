...
def _english_official() -> list[dict]:
    pairs = [
        ...
        ("typescript", "https://devblogs.microsoft.com/typescript", "https://devblogs.microsoft.com/typescript/feed/", "official_blog"),
        ...
        ("ruby", "https://www.ruby-lang.org/en/news/", "https://www.ruby-lang.org/en/feeds/news.rss", "official_blog"),
        ("ruby", "https://docs.ruby-lang.org/en/", None, "docs_changelog"),
        ("kotlin", "https://blog.jetbrains.com/kotlin", "https://blog.jetbrains.com/kotlin/feed/", "official_blog"),
        ...
        ("android", "https://android-developers.googleblog.com", "https://android-developers.googleblog.com/feeds/posts/default", "official_blog"),
        ...
        ("postgresql", "https://www.postgresql.org/about/newsarchive/", "https://www.postgresql.org/news.rss", "official_blog"),
...
def _english_corp() -> list[dict]:
    pairs = [
        ...
        ("typescript", "https://devblogs.microsoft.com", "https://devblogs.microsoft.com/feed/", "corp_tech_blog"),
        ("rust", "https://blog.cloudflare.com/tag/rust", None, "corp_tech_blog"),
        ("rust", "https://aws.amazon.com/blogs/opensource/", "https://aws.amazon.com/blogs/opensource/feed/", "corp_tech_blog"),
        ("go", "https://engineering.grab.com", None, "corp_tech_blog"),
        ("go", "https://www.uber.com/blog/engineering/", None, "corp_tech_blog"),
        ("python", "https://instagram-engineering.com", "https://instagram-engineering.com/feed", "corp_tech_blog"),
        ...
        ("swift", "https://developer.apple.com/news/", "https://developer.apple.com/news/rss/news.rss", "corp_tech_blog"),
        ("java", "https://www.infoq.com/java/", None, "corp_tech_blog"),
        ("llvm", "https://research.google/blog/", None, "corp_tech_blog"),
        ("android", "https://medium.com/androiddevelopers", "https://medium.com/feed/androiddevelopers", "corp_tech_blog"),
        ...
        ("oss_security", "https://securitylab.github.com", "https://securitylab.github.com/feed.xml", "corp_tech_blog"),
        ...
        ("rust", "https://security.googleblog.com", "https://security.googleblog.com/feeds/posts/default", "corp_tech_blog"),
        ("kubernetes", "https://aws.amazon.com/blogs/containers/", "https://aws.amazon.com/blogs/containers/feed/", "corp_tech_blog"),
...
def _english_personal_and_feeds() -> list[dict]:
    pairs = [
        ...
        ("rust", "https://smallcultfollowing.com/babysteps/", "https://smallcultfollowing.com/babysteps/atom.xml", "personal_dev_blog"),
        ...
        ("go", "https://eli.thegreenplace.net", "https://eli.thegreenplace.net/feeds/all.atom.xml", "personal_dev_blog"),
        ("python", "https://realpython.com", "https://realpython.com/atom.xml", "personal_dev_blog"),
        ("python", "https://nedbatchelder.com/blog", "https://nedbatchelder.com/blog/rss.xml", "personal_dev_blog"),
        ("ruby", "https://tenderlovemaking.com", "https://tenderlovemaking.com/atom.xml", "personal_dev_blog"),
        ("ruby", "https://jemma.dev", None, "personal_dev_blog"),
        ("kotlin", "https://blog.kotlin-academy.com", None, "personal_dev_blog"),
        ("swift", "https://www.swiftbysundell.com", "https://www.swiftbysundell.com/rss", "personal_dev_blog"),
        ...
        ("typescript", "https://www.totaltypescript.com", "https://www.totaltypescript.com/rss.xml", "personal_dev_blog"),
        ...
        ("oss_security", "https://googleprojectzero.blogspot.com", "https://googleprojectzero.blogspot.com/feeds/posts/default", "personal_dev_blog"),
        ...
        ("python", "https://pyfound.blogspot.com", "https://pyfound.blogspot.com/feeds/posts/default", "rss_atom_json"),
...
def _japanese() -> list[dict]:
    ...
    corp = [
        ...
        ("https://engineering.linecorp.com/ja", "https://engineering.linecorp.com/ja/feed", "java", "corp_tech_blog"),
        ("https://developers.cyberagent.co.jp", "https://developers.cyberagent.co.jp/blog/feed/", "typescript", "corp_tech_blog"),
        ...
        ("https://developer.mamezou-tech.com", "https://developer.mamezou-tech.com/feed", "java", "corp_tech_blog"),
    ...
    official = [
        ("https://www.ruby-lang.org/ja/news/", "https://www.ruby-lang.org/ja/feeds/news.rss", "ruby", "official_blog"),
...
def _pad_to_floors(rows: list[dict]) -> list[dict]:
    ...
    extras = [
        ...
        ("https://redis.io/docs/latest/operate/oss_and_stack/install/release-notes/", "redis", "docs_changelog", "en"),
        ...
        ("https://www.typescriptlang.org/docs/handbook/release-notes/overview.html", "typescript", "docs_changelog", "en"),
...
def main() -> int:
    ...
    (OUT / "g0_freeze.json").write_text(json.dumps(freeze, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
        ...
        json.dumps(
            {
                ...
                "attested_by": None,
                "attested_at": None,
                "instruction": "Review sources.json. If the public-URL set is accepted as human-curated gold, set status=attested, attested_by to the operator login, and attested_at to an ISO-8601 timestamp. Do not attest after reading blind results.",
            },
            ensure_ascii=False,
            indent=2,
        )
