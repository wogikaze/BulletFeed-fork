...
_CONCEPTS: tuple[_ConceptSpec, ...] = (
    _spec(
        ...
        ("llvm", "llvm-scalar-evolution", "rust"),
    ),
    _spec(
        "llvm",
        "LLVM",
        ("llvm", "llvm ir", "llvm pass"),
        ("compiler-optimization", "llvm-scalar-evolution", "rust"),
    ),
    _spec(
    ...
    _spec("javascript", "JavaScript", ("javascript", "ecmascript"), ("typescript", "react", "npm")),
    _spec(
        "go",
        "Go",
    ...
    _spec("npm", "npm", ("npm", "npmjs", "npm registry"), ("javascript",)),
    _spec("pypi", "PyPI", ("pypi", "pypi.org"), ("python",)),
    _spec(
        "swift",
        "Swift",
