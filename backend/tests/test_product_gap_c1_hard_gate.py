...
def test_replay_metrics_cannot_close_hard_gate() -> None:
    ...
    assert report["gates"]["g1"]["deterministic_replay_pass"] is True
    assert report["gates"]["g1"]["completion_gate_pass"] is False
    assert report["gates"]["g2"]["evidence"] == "g0_catalog_hints_replay_not_independent_discovery"
    ...
    assert report["gates"]["g5"]["deterministic_ssrf_pass"] is True
